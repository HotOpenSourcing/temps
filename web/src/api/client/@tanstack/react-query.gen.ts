...
export const getPagePathsSparklineQueryKey = (options: Options<GetPagePathsSparklineData>) => createQueryKey('getPagePathsSparklines', options);

export const getPagePathsSparklineOptions = (options: Options<GetPagePathsSparklineData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getPagePathsSparklineQueryKey(options)
    });
};
