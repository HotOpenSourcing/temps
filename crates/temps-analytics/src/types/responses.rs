...
pub struct VisitorFacets {
    ...
    pub event: Vec<VisitorFacetValue>,
    pub browser: Vec<VisitorFacetValue>,
    pub os: Vec<VisitorFacetValue>,
    pub device: Vec<VisitorFacetValue>,
    pub language: Vec<VisitorFacetValue>,
    pub utm_source: Vec<VisitorFacetValue>,
    pub utm_medium: Vec<VisitorFacetValue>,
    pub utm_campaign: Vec<VisitorFacetValue>,
    pub utm_term: Vec<VisitorFacetValue>,
    pub utm_content: Vec<VisitorFacetValue>,
}
