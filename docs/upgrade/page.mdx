...
- Review the [Troubleshooting](/docs/reference/troubleshooting) guide if you encounter issues
- Set up [Backups](/docs/features/backups) to automate pre-upgrade snapshots
