export const metadata = {
  ...
  alternates: {
    canonical: "/docs/features/rollbacks",
  },
};
...
- **[Deployment Pipeline](/docs/architecture/deployment)** - Understand how deployments work
- **[Monitoring](/docs/features/monitoring)** - Set up alerts for deployments
- **[Error Tracking](/docs/features/error-tracking)** - Track deployment errors
