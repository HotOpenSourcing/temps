export const metadata = {
  ...
  alternates: {
    canonical: "/docs/features/attack-mode",
  },
};
...
- [Monitoring](/docs/features/monitoring) -- Monitor application health and resource usage
- [Error Tracking](/docs/features/error-tracking) -- Track and debug application errors
- [Logs](/docs/features/logs) -- View application and deployment logs
- [Architecture: Security](/docs/architecture/security) -- Security architecture overview
