export const metadata = {
  ...
  alternates: {
    canonical: '/docs/features/managed-services',
  },
}
...
- [Configure Environment Variables](/docs/tutorials/environment-variables) to inject service credentials
- [Set up Resource Limits](/docs/concepts/resources) to allocate CPU and memory
- [Enable Monitoring](/docs/features/monitoring) to track service health
- [Configure Backups](/docs/features/backups) to customize backup retention
