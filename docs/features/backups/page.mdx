export const metadata = {
  ...
  alternates: {
    canonical: '/docs/features/backups',
  },
}
...
- **[Rollbacks](/docs/features/rollbacks)** - Quick recovery from bad deployments
- **[Monitoring](/docs/features/monitoring)** - Monitor backup success
- **[Managed Services](/docs/features/managed-services)** - Database backup options
