export const metadata = {
  ...
  alternates: {
    canonical: '/docs/features/cron-jobs',
  },
}
...
- **[Environment Variables](/docs/tutorials/environment-variables)** - Store cron secrets securely
- **[Monitoring](/docs/features/monitoring)** - Track cron job health
- **[Error Tracking](/docs/features/error-tracking)** - Catch cron endpoint errors
- **[Logs](/docs/features/logs)** - Debug failed executions
