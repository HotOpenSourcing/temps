export const metadata = {
  ...
  alternates: {
    canonical: '/docs/reference/cli-getting-started',
  },
}
...
- [CLI Reference](/docs/reference/cli) - Complete command reference with all options
- [API Reference](/docs/reference/api) - Use the REST API directly
- [Environment Variables Reference](/docs/reference/environment-variables) - All configuration options
