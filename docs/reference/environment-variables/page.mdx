export const metadata = {
  ...
  alternates: {
    canonical: "/docs/reference/environment-variables",
  },
};
...
<div className="not-prose">
  <Button href="/docs/reference/api" variant="text" arrow="left">
    API Reference
  </Button>
  <Button href="/docs/reference/cli" variant="text" arrow="right">
    CLI Reference
  </Button>
</div>
