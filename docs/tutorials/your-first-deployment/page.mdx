export const metadata = {
  ...
  alternates: {
    canonical: '/docs/tutorials/your-first-deployment',
  },
}
...
| Covered | Not covered |
|---------|-------------|
| Installing Temps | Analytics and session replay ([next tutorial](/docs/tutorials/add-observability)) |
| Connecting a Git provider | Environment variables in depth ([how-to guide](/docs/howto/manage-environment-variables)) |
| Creating a project and deploying | CI/CD pipelines ([how-to guide](/docs/howto/set-up-ci-cd-pipeline)) |
| Adding a custom domain | Scaling and resource management ([how-to guide](/docs/howto/scale-for-traffic)) |
...
<div className="not-prose">
  <Button href="/docs/tutorials/add-observability" variant="text" arrow="right">
  ...
  <Button href="/docs/tutorials/deploy-with-database" variant="text" arrow="right">
