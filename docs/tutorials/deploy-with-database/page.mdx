export const metadata = {
  ...
  alternates: {
    canonical: '/docs/tutorials/deploy-with-database',
  },
}
...
| Querying data from the dashboard | Backup and restore ([previous tutorial](/docs/tutorials/set-up-backups-and-monitoring)) |
...
- A **running Temps instance** with a deployed project (complete [Your First Deployment](/docs/tutorials/your-first-deployment) first)
...
This gives your [uptime monitor](/docs/tutorials/set-up-backups-and-monitoring#create-an-uptime-monitor) a way to detect database outages, not just application crashes.
...
<div className="not-prose">
  ...
  <Button href="/docs/howto/manage-environment-variables" variant="text" arrow="right">
    Manage environment variables across environments
  </Button>
  <Button href="/docs/howto/scale-for-traffic" variant="text" arrow="right">
    Scale your application and database for more traffic
  </Button>
  <Button href="/docs/concepts/environments" variant="text" arrow="right">
