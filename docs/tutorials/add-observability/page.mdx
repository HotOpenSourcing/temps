export const metadata = {
  ...
  alternates: {
    canonical: '/docs/tutorials/add-observability',
  },
}
...
- A **deployed application on Temps** (if you have not deployed yet, complete [Your First Deployment](/docs/tutorials/your-first-deployment) first)
- A **React or Next.js application** — this tutorial uses the React SDK. If your app uses a different framework, see [Analytics & Observability](/docs/features/analytics) for vanilla JS instructions.
...
<Note>
**Privacy:** Password inputs are always masked. Session recordings are stored on your server and are never sent to third parties. Use `blockClass` and `maskAllInputs` to control what is captured. See [Privacy & Compliance](/docs/features/analytics#privacy) for GDPR configuration.
</Note>
...
<div className="not-prose">
  <Button href="/docs/tutorials/set-up-backups-and-monitoring" variant="text" arrow="right">
    Set up automated backups and uptime monitoring
  </Button>
  <Button href="/docs/features/analytics#funnel-analysis" variant="text" arrow="right">
    Create conversion funnels to track user journeys
  </Button>
  <Button href="/docs/features/analytics#enrich-visitors" variant="text" arrow="right">
    Enrich visitor data from your backend
  </Button>
  <Button href="/docs/concepts/deployments" variant="text" arrow="right">
