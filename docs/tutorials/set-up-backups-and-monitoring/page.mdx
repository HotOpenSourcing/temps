export const metadata = {
  ...
  alternates: {
    canonical: '/docs/tutorials/set-up-backups-and-monitoring',
  },
}
...
| Covered | Not covered |
|---------|-------------|
| Connecting S3 storage for backups | Setting up managed databases ([tutorial](/docs/tutorials/deploy-with-database)) |
| Manual and scheduled backups | CI/CD pipeline configuration ([how-to guide](/docs/howto/set-up-ci-cd-pipeline)) |
...
- A **running Temps instance** with at least one deployed project (complete [Your First Deployment](/docs/tutorials/your-first-deployment) first)
...
<div className="not-prose">
  ...
  <Button href="/docs/howto/debug-a-failed-deployment" variant="text" arrow="right">
  ...
  <Button href="/docs/howto/roll-back-a-deployment" variant="text" arrow="right">
