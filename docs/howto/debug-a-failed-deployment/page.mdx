export const metadata = {
  ...
  alternates: {
    canonical: '/docs/howto/debug-a-failed-deployment',
  },
}
...
If the previous version was working, [roll back](/docs/howto/roll-back-a-deployment) to it while you investigate.
