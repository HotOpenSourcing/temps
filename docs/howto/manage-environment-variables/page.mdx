export const metadata = {
  ...
  alternates: {
    canonical: '/docs/howto/manage-environment-variables',
  },
}
...
See [Deploy with a Database](/docs/tutorials/deploy-with-database#understand-the-injected-environment-variables) for the full list.
