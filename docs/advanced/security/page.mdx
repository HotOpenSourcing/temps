export const metadata = {
  ...
  alternates: {
    canonical: '/docs/advanced/security',
  },
}
...
<div className="not-prose">
  <Button href="/docs/features/monitoring" variant="text" arrow="right">
    Monitoring & Uptime Checks
  </Button>
  <Button href="/docs/features/backups" variant="text" arrow="right">
    Backup & Disaster Recovery
  </Button>
  <Button href="/docs/advanced/networking" variant="text" arrow="right">
    Advanced Networking
  </Button>
  <Button href="/docs/reference/api" variant="text" arrow="right">
    API Reference
  </Button>
</div>
