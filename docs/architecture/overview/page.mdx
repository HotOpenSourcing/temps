export const metadata = {
  ...
  alternates: {
    canonical: '/docs/architecture/overview',
  },
}
...
**Learn more:** [Deployment Pipeline](/docs/architecture/deployment)
...
**Learn more:** [Data Flow](/docs/architecture/data-flow)
...
**Learn more:** [Security Architecture](/docs/architecture/security)
...
- **[Deployment Pipeline](/docs/architecture/deployment)** - Learn how deployments work
- **[Data Flow](/docs/architecture/data-flow)** - Understand analytics and monitoring
- **[Security Architecture](/docs/architecture/security)** - Security features available to you
