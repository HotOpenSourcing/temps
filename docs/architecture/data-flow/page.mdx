export const metadata = {
  ...
  alternates: {
    canonical: '/docs/architecture/data-flow',
  },
}
...
- **[Overview](/docs/architecture/overview)** - System capabilities
- **[Deployment Pipeline](/docs/architecture/deployment)** - How deployments work
- **[Security Architecture](/docs/architecture/security)** - Security features
