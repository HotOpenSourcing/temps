export const metadata = {
  ...
  alternates: {
    canonical: '/docs/architecture/plugins',
  },
}
...
<div className="not-prose">
  <Button href="/docs/architecture/overview" variant="text" arrow="left">
    Architecture Overview
  </Button>
  <Button href="/docs/architecture/request-flow" variant="text" arrow="right">
    Request Flow
  </Button>
</div>
